...
map <- ggplot() +
  ...
  # Locations - pink
  geom_sf(
    data = locations_pink$osm_multipolygons,
    fill = "LightPink",
    colour ="LightPink"
  ) +
  # Locations - blue
  geom_sf(
    data = locations_blue$osm_multipolygons,
    fill = "PaleTurquoise",
...
ggsave("./static/route_june_17th.png", map, dpi = 1000)
