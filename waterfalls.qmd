...
listing:
  ...
  - id: listing-barnafoss
    ...
    filter-ui: false
    categories: false
  - id: listing-hraunfossar
    template: gallery.ejs
    contents:
        - /static/waterfalls/hraunfossar/*.jpg
    sort-ui: false
    filter-ui: false
    categories: false
  - id: listing-dynjandi
    template: gallery.ejs
    contents:
        - /static/waterfalls/dynjandi/*.jpg
    sort-ui: false
    filter-ui: false
    categories: false
  - id: listing-dynjandi-other
    template: gallery.ejs
    contents:
        - /static/waterfalls/hundafoss/*.jpg
        - /static/waterfalls/misc_dynjandi_1/*.jpg
        - /static/waterfalls/misc_dynjandi_2/*.jpg
        - /static/waterfalls/misc_dynjandi_3/*.jpg
        - /static/waterfalls/misc_dynjandi_4/*.jpg
        - /static/waterfalls/bunarfoss/*.jpg
        - /static/waterfalls/fossfjordur/*.jpg
        - /static/waterfalls/hundafoss/*.jpg
    sort-ui: false
    filter-ui: false
    categories: false
...
Downstream from **Barnafoss** is **Hraunfossar**. This is a series of waterfalls formed by rivulets streaming out of the **Hallmundarhraun**, a lava field which flowed from an eruption of one of the volcanoes lying under the glacier Langjökull.
...
{{< video https://www.youtube.com/embed/hF_GJzxA-Z8 width="337.5" height="600" >}}
...
The last waterfall we visited in iceland is **Dynjandi**, also known as **Fjallfoss** (*Mountain Falls*). It is the largest waterfall in the Westfjords, with a total height of 100 meters.
...
<!-- {{< video https://www.youtube.com/embed/6jC16gbakbw width="600" height="337.5" >}} -->
{{< video https://www.youtube.com/embed/BEaK9wWnh5k width="600" height="337.5" >}}
...
# Some other waterfalls around Iceland

## Various dates

::: {#listing-dynjandi-other}
:::
