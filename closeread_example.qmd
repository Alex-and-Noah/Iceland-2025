...
plain text markdown in your favorite editor. [@cr-quarto]{scale-by="2"}

1 [@cr-quarto]{pan-to="50%,50%"}

2 [@cr-quarto]{pan-to="-50%,50%"}

3 [@cr-quarto]{pan-to="-50%,-50%"}

4 [@cr-quarto]{pan-to="50%,-50%"}
